...
public:
    ...
    // Decoupled compositor path. One GPU job may span several display frames.
    // Only CommitSubmission releases its images; display repeats use the last
    // released images and their original rendering poses.
    OpenXRD3D12BeginStatus BeginDisplayFrame(const OpenXRD3D12Presentation& presentation,
                                            OpenXRD3D12Frame& frame);
